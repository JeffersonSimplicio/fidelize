...
import { ListRedeemedRewardsForCustomerUseCase } from "@/core/application/use-cases/customer-rewards/list-redeemed-rewards-customer.use-case";
...
export const listRedeemedRewardsForCustomer = new ListRedeemedRewardsForCustomerUseCase(
  rewardRepository,
  customerRepository,
