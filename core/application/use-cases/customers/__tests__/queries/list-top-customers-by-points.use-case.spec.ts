...
describe("ListTopCustomersByPointsUseCase", () => {
  ...
  it("should call repository with the provided positive limit", async () => {
    ...
    expect(customerQueryRepo.findTopCustomersByPoints).toHaveBeenCalledWith(providedLimit);
  ...
  it("should propagate errors thrown by the repository", async () => {
    customerQueryRepo.findTopCustomersByPoints.mockRejectedValue(new Error("DB failure"));
