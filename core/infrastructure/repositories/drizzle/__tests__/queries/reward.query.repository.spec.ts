...
describe('RewardQueryRepositoryDrizzle', () => {
  ...
  describe('findByName', () => {
    ...
    it('should propagate DB errors', async () => {
      ...
      await expect(repository.findByName('Error')).rejects.toThrow(
  ...
  describe('findAllInactive', () => {
    ...
    it('should propagate DB errors during inactive fetch', async () => {
      ...
      await expect(repository.findAllInactive()).rejects.toThrow(
        'Inactive Query Failed',
      );
    });
  });
});
