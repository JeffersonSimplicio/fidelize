    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Nome */}
          <View className="mb-4">
            <Text className="mb-1 text-gray-700">Título:</Text>
            <TextInput
          ...
          {/* Pontos necessários */}
          <View className="mb-4">
            <Text className="mb-1 text-gray-700">Pontos necessários:</Text>
            <NumberInput
          ...
          {/* Descrição */}
          <View className="mb-6">
            <Text className="mb-1 text-gray-700">Descrição:</Text>
            <TextInput
              className="rounded-lg border border-gray-300 p-2 text-gray-800 focus:border-blue-500 focus:ring-1 focus:ring-blue-400"
